...
dataset1 = r"C:\Users\AMAAL\Downloads\Movies Review\Naive Bayes - 1\Naive Bayes - 1/PandNDataSet.csv"
table = pd.read_csv(dataset1)
negative = (table['neg'])
positive = (table['pos'])
dataset2 = r"C:\Users\AMAAL\Downloads\Movies Review\Naive Bayes - 1\Naive Bayes - 1/bad-words.csv"
